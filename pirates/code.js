...
onEvent("image2", "click", function( ) {
  if (sound == 1){
    sound = 0;
    setImageURL("image2", "assets/soundoff.png");
  }else{
    playSound("assets/coin1.mp3");
    sound = 1;
    setImageURL("image2", "assets/soundon.png");
}});
setEng();
...
onEvent("lang", "click", function( ) {
  playS("assets/coin1.mp3");
  if (isChi == 0){
    isChi = 1;
    showElement("text_area2");
    setImageURL("image3", "assets/prepc.jpg");
    setText("stat", "全球\n统计");
...
function setEng(){
  ...
  setImageURL("image3", "assets/prep.JPG");
...
var walls = [];
var map = 0;
var mapvar = [{h:"assets/hurt.jpg",m:"assets/Captue.jpg",l:"Record"},{h:"assets/2hurt.jpg",m:"assets/map2.jpg",l:"Record2"}];
var threeP, immune, pickOne,v,lBo,uBo,salt,s2, pickTwo,health, eone, etwo, ethr, health2, health1, playerX, playerY, moveLeft, moveRight, moveUp, moveDown, spe, timer, process, xp, score, spedLow, hard, coin1X, coin1Y, coin2X, coin2Y, coin3X, coin3Y, coin4X, coin4Y, enemyOneX, enemyOneY, enemyTwoX, enemyTwoY, oneTgtX, oneTgtY;
...
function moveEnemyOne(){
  ...
  setPosition("enemyOne", enemyOneX, enemyOneY, 20, 20);
  if (xD > 0){
    setImageURL("enemyOne", "assets/BO2.png");
  }else{
    setImageURL("enemyOne", "assets/BO1.png");    
...
function moveEnemyTwo(){
  ...
  if (xD > 0){
    setImageURL("enemyTwo", "assets/c0.png");
  }else{
    setImageURL("enemyTwo", "assets/c1.png");    
  }
...
onEvent("button5", "click", function() {
  ...
  map = 0;
  setImageURL("aaa","assets/Captue.jpg");
	startGaming();
});
onEvent("button6", "click", function() {
  ...
  map = 1;
  setImageURL("aaa","assets/map2.jpg");
	startGaming();
});
...
setImageURL("loa", "assets/BO2.png");
setImageURL("loa", "assets/c1.png");
setImageURL("loa", "assets/hurt.jpg");
