...
function playS(n, e, t, o, i, a, c) {
    if (vault1 = vault2 = 0, 0 == fuse) {
        tem == n ? (setText("text_area20",""), setText("text_area19",""),setText("ta21",""), setText("textarea" + e, "ID: "+n+"\nLength: " + o + "\nSize: " + i + " KB\nFormat: " + a + "\n\nPlayback: "), fadeIn(["cover","cove","textarea5","textarea13","exit","button33","button32","button34","ta21","text_area19","text_area20","textarea11","button14","cov","button18"])) : (stopSound(), tem = n, (e == "5")? playSound("https://studio.code.org/v3/assets/E9k2k97H2vusHrk0pORYhU9XDmJ7cyNsBNATfkCrqxM/"+ n + ".mp3") : (e == "13")? playSound("https://studio.code.org/v3/assets/CSRZ1SNZRLL-2HldukluE-8HI2BOCaXnaYbMhm_423A/"+ n + ".mp3"):  (e == "11")? playSound("https://studio.code.org/v3/assets/IOO3385jGkG720HrnXBsKGi4z6DQXcmC0HrFqLbbj3o/"+ n + ".mp3"): playSound(), setText("text_area" + e, t), stopTimedLoop(tl), tl = timedLoop(16600, function() {
